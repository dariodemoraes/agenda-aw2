...
<?php
if ($_POST) {
    $dados = fopen($_SERVER['DOCUMENT_ROOT'] . "/data/eventos.txt", "a") or die("Erro ao abrir arquivo!");
    fwrite($dados, $_COOKIE['login'] . "/" . $_POST['nome'] . "/" . $_POST['data'] . "\r\n");
    fclose($dados);
}
?>
...
<head>
  ...
  <title>semiSUAP - Dashboard</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Seja bem vindx, <?php echo $_SESSION['nome']; ?>!</h1>
          </div>
