  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{action('AlunoController@mostrarTelaPrincipal')}}">
        ...
        <div class="sidebar-brand-text mx-3">semiSUAP <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{action('UtilitarioController@blank')}}">Blank Page</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <!--<h1 class="h3 mb-4 text-gray-800">Adicionar Evento</h1>-->
          
          <!-- FORMULARIO CRIAR NOVO EVENTO -->
        <div class="card mb-4">
